...
const Order = require("../models/Order.model"); // Mengimpor model Order
const OrderDetails = require("../models/OrderDetails.model"); // Mengimpor model OrderDetails
const ShippingDetails = require("../models/ShippingDetails.model"); // Mengimpor model ShippingDetails
const Product = require("../models/Product.model"); // Mengimpor model Product
...
router.post("/", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    const order = await Order.create({ userId, status: "new", totalAmount });
